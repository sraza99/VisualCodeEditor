...
COPY company_dim
FROM 'C:\Users\sraza\VisualCodeEditor\PostGres\ProjectDataAnalysis\company_dim.csv'
...
COPY skills_dim
FROM 'C:\Users\sraza\VisualCodeEditor\PostGres\ProjectDataAnalysis\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\sraza\VisualCodeEditor\PostGres\ProjectDataAnalysis\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\sraza\VisualCodeEditor\PostGres\ProjectDataAnalysis\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
